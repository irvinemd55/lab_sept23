...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var messageSum = a + ' and ' + b + ' and ' + c + ' sum to ' + finalSum + '.';
  console.log(messageSum);
  var messageProduct = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + finalProduct + '.';
  console.log(messageProduct);
  var outputSumAndMultiply = [finalSum, finalProduct, messageSum, messageProduct];
  return outputSumAndMultiply;
}
...
function sumArray(testArray){ //eslint-disable-line
  ...
  var messageArray = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + totalSum + ' is their sum.';
  var output = [totalSum, messageArray];
  return output;
}
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  console.log(finalProduct);
  var messageArray = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + finalProduct + '.';
  console.log(messageArray);
  var output = [finalProduct, messageArray];
  console.log (output);
  return output;
}
